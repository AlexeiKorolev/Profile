...
const ProjectCard = ({ title, description, image, skills, links }) => (
    <div className="project-card" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.3)), url(${image})` }}>
